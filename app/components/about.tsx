export default function About() {
  ...
  return (
    <section id="about" role="region" aria-labelledby="about-heading" className="py-20 px-4 sm:px-6 lg:px-8 bg-gray-50 dark:bg-gray-800">
      <div className="container mx-auto max-w-6xl">
        <div className="text-center mb-16">
          <h2 id="about-heading" className="text-3xl sm:text-4xl font-bold text-gray-900 dark:text-white mb-4">About Me</h2>
        ...
        <div className="grid grid-cols-2 gap-8">
          {skills.map((skill, index) => (
            <div key={index} className="bg-white dark:bg-gray-900 p-6 rounded-lg shadow-sm hover:shadow-md text-center">
              <div className="text-4xl mb-4" aria-hidden="true">{skill.icon}<span className="sr-only">{skill.title} icon</span></div>
